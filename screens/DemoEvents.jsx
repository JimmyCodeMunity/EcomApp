...
import { View, Image, Dimensions, Text, Linking, TouchableWithoutFeedback, Alert } from 'react-native';
...
const DemoEvents = ({ email, handleModal, logstate }) => {
...
const ProductCard = ({ item, logstate, handleModal }) => {
    const navigation = useNavigation()
    const requestLogin = () => {
        Alert.alert('Please Login to view Ads.')
    }
    ...
    return (
        ...
        <TouchableWithoutFeedback onPress={requestLogin}
        >
