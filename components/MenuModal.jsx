...
const MenuModal = ({ isBottomSheetVisible, setBottomSheetVisible, Email }) => {
  ...
  return (
    ...
    >
      <View
        className=""
        style={[styles.bottomSheetContainer1, { height: windowHeight * 0.9 }]}
      >
        <TouchableOpacity
          onPress={() => setBottomSheetVisible(!setBottomSheetVisible)}
        >
          ...
          <View style={styles.logmenu} className="bg-white p-4 flex-1 w-full">
            ...
            <View className="justify-center mt-7">
              <View className="border border-b-2 justify-center border-slate-300 h-30 rounded-2xl mb-5">
                ...
                >
                  <Text className="text-slate-600 ">All Suppliers</Text>
                ...
                <TouchableOpacity
                  onPress={() =>
                    navigation.navigate(
                      "Contact",
                      { userEmail: Email },
                      setBottomSheetVisible(TurboModuleRegistry)
                    )
                  }
                  className="p-5 rounded-2xl w-full justify-between flex-row items-center"
                >
              ...
              <View className="border mt-8 border-b-2 border-slate-300 h-30 rounded-2xl mb-5">
                <TouchableOpacity
                  ...
                  className="p-5 rounded-2xl w-full flex-row justify-between items-center border border-b-1 border-t-0 border-l-0 border-r-0 border-slate-300 "
                >
                  <Text className="text-slate-600 ">Our Story</Text>
                  <FeatherIcon name="arrow-right" size={20} color="gray" />
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() =>
